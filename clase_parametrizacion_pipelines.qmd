...
def extraer_datos(year, output_dir):
    """Extrae datos de California Housing."""
    print(f"📥 Extrayendo datos para {year}...")
    
    # Cargar dataset
    california = fetch_california_housing(as_frame=True)
    df = california.frame
    
    # Agregar columna de año simulada
    df['year'] = year
...
def main():
    parser = argparse.ArgumentParser(description='Extraer datos')
    parser.add_argument('--year', type=int, required=True)
    parser.add_argument('--output-dir', default='data/raw')
    args = parser.parse_args()
    
    extraer_datos(args.year, args.output_dir)
...
- Tiene notebooks de exploración
